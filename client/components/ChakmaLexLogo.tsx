        ...
        <div className="relative h-full w-full rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div className="absolute inset-0 opacity-20">
            <svg className="w-full h-full" viewBox="0 0 64 64" fill="none">
              ...
              <path d="M16 12 Q32 8 48 12 Q52 24 48 36 Q32 40 16 36 Q12 24 16 12" fill="white" fillOpacity="0.3" />
              <path d="M20 20 Q32 16 44 20 Q48 28 44 36 Q32 40 20 36 Q16 28 20 20" fill="white" fillOpacity="0.2" />
  ...
  return (
    <div className={cn("relative", className)}>
      <div className="h-16 w-16 relative">
        ...
        <div className="absolute inset-1 rounded-full border-2 border-transparent bg-gradient-to-r from-purple-600 via-blue-500 to-emerald-400 animate-spin" style={{ animationDirection: 'reverse', animationDuration: '3s' }}>
          <div className="absolute inset-0 rounded-full bg-white" />
        </div>
      ...
      <div className="relative h-full w-full bg-gradient-to-br from-emerald-500 via-blue-600 to-purple-700 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <svg className="w-full h-full" viewBox="0 0 32 32" fill="none">
            <circle cx="16" cy="16" r="8" stroke="white" strokeWidth="1" fill="none" opacity="0.4" />
